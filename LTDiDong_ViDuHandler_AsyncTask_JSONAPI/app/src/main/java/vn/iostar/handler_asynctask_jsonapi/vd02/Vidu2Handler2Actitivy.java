...
public class Vidu2Handler2Actitivy extends AppCompatActivity {
    ...
    ViDu2RecyclerViewAdapter recyclerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vidu2_handler2);
    ...
    private void populateData() {
        int i = 0;
        while (i < 10) {
            rowsArrayList.add("Item " + (i+1));
            i++;
        }
    }

    private void initAdapter() {
        recyclerViewAdapter = new ViDu2RecyclerViewAdapter(rowsArrayList);
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                while (currentSize < nextLimit) {
                    rowsArrayList.add("Item " + (currentSize+1));
                    currentSize++;
                }
